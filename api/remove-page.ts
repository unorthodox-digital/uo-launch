...
/**
 * Remove a client launch page: its files, its manifest entry, and its
 ...
 *
 * Files and manifest go in ONE commit, the same way /newpagelaunch writes them, so
...
async function handler(req: Request): Promise<Response> {
  ...
  const repo = process.env.UO_LAUNCH_REPO ?? "unorthodox-digital/uo-launch";
